...
public class AnimationOld implements TimeBasedObject {
    ...
    public AnimationOld(SpriteSheet sprite, double duration) {

        this(sprite, duration, true);
    }

    public AnimationOld(SpriteSheet sprite, double duration, boolean stopped) {
